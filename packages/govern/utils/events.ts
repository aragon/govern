...
export function setUpRegisteredEvent(registryAddress: string, signer: providers.Provider | Signer, fn: Function, daoName: string) {
    ...
    let GovernRegistry = new Contract(
        registryAddress,
        registryAbi,
        signer
    )
